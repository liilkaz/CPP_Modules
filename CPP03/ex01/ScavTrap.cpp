...
void ScavTrap::attack(std::string const & target) {
	std::cout << "\033[36m" << "ScavTrap: " << "\033[0m" << name << " attacks " << target << ", causing " << attack_damage << " points of damage!" << std::endl;
}

void ScavTrap::guardGate() {
std::cout << "\033[36m" << "ScavTrap: " << "\033[0m" << name << " has enterred in Gate keeper mode" << std::endl;
}
